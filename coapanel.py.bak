...
def special():
    clear()
    si()
    os.system(f'figlet -r COA SPECIAL | lolcat')
    print(f'''
                                \x1b[38;2;0;212;14m╔═══════════════╗
...
def menu():
    ...
    sys.stdout.write(f"         \x1b]2;PREMIUM COA PANEL --> Stars: [{bots}] | Online Users: [1] | Methods: [25] | Bypass: [10] | Amps: [1]\x07")
    clear()
    print('\x1b[38;2;0;255;255m[ \x1b[38;2;233;233;233mRoot: COA\x1b[38;2;0;255;255m] | \x1b[38;2;233;233;233mWelcome to COA PANEL\x1b[38;2;0;255;255m| \x1b[38;2;233;233;233mOwner: All Team COA  \x1b[38;2;0;255;255m| \x1b[38;2;233;233;233mUpdate v1.1')
    print("")
    print("""
